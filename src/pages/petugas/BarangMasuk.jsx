...
const BarangMasukPetugas = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        if (!formData.id_barang || formData.jumlah <= 0 || formData.harga_beli <= 0) {
            Swal.fire({
                icon: 'warning',
                title: 'Data Tidak Valid!',
                text: 'Pastikan barang, jumlah, dan harga beli sudah benar.',
        ...
        <MasterLayout>
            ...
            <div className="mb-4">
                ...
                <p className="text-muted mb-0">
                    Gunakan form ini untuk menambah stok barang yang baru datang.
                </p>
            </div>
                        ...
                        <form onSubmit={handleSubmit}>
                            ...
                            <div className="mb-3">
                                ...
                                <div className="info-box small text-muted">
                                    ...
                                    <div>
                                        Sistem akan otomatis menambahkan stok sesuai jumlah input.
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="mb-4">
                                ...
                                <textarea
                                    ...
                                    className="form-control"
                                    rows="3"
                                    placeholder="Contoh: Barang dari supplier pusat"
                            ...
                            <button
                                type="submit"
                                className="btn btn-primary btn-simpan w-100 d-flex align-items-center justify-content-center"
                    ...
                    <div className="card-custom">
                        <div className="mb-4">
                            ...
                            <p className="text-muted small mb-0">
                                Semua transaksi masuk yang tercatat hari ini.
                            </p>
                        </div>
